  ...
  <div class="container-fluid">
    ...
    <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
      <div class="card border-info mb-3" style="max-width: 18rem;">
        <div class="card-header">Fathar Arsa Siregar</div>
        <div class="card-body">
          <h5 class="card-title">Universtas Malikussaleh</h5>
        </div>
      </div>
    </div>
    </section>
    ...
    <footer id="footer" class="p-3 bg-dark">
      ...
      <div class="row p-3">
        <div class="col mt-3">
          ...
          <p class="text-secondary fs-6">Bukit Indah</p>
        </div>
        ...
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">Made width ❤️ <a href="" class="text-decoration-none">Fathar Arsa Siregar</span> © 2025</p>
        </div>
      </div>
    </footer>
